...
enum TagMatching {
    ...
    static func matches(tag: QueryTag, tagSegments: [[String]]) -> Bool {
    ...
    static func decodeSegments(fromJSON json: String) -> [[String]] {
    ...
    static func encodeSegments(_ segments: [[String]]) -> String {
